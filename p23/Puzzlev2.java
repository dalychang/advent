...
public class Puzzlev2 {
  ...
  public record ChokePath(Position startPosition, Position position, Set<Position> traveled, long distance) {}
  ...
  private static long findLongestPath(Map<ChokePointPair, Integer> chokeMap, Position startingPoint, Position endingPoint, Set<Position> chokePoints, HashMultimap<Position, Position> travelPoints) {
    ...
    paths.add(new ChokePath(startingPoint, startingPoint, Set.of(startingPoint), 0L));
    ...
    while (!paths.isEmpty()) {
      ...
      for (Position nextPosition : travelPoints.get(currentPath.position())) {
        ...
        ChokePath nextPath = new ChokePath(currentPath.startPosition(), nextPosition, traveled, distance);
  ...
  public static void main(String[] args) throws Exception {
    ...
    long answer = findLongestPath(chokeMap, startingPoint, endingPoint, chokePoints, travelPoints);
